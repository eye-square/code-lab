...
function checkIfPrimeNumber (numberToCheck) {
  for ( let divider = 2; divider < numberToCheck; divider++){
...
console.log(checkIfPrimeNumber(2));
console.log(checkIfPrimeNumber(13));
console.log(checkIfPrimeNumber(4));
console.log(checkIfPrimeNumber(9999999999999999999999));
